...
class Transform(nn.Module):
    ...
    def forward(self, content4_1, style4_1, content5_1, style5_1,arfa4_1,arfa5_1):
        ...
        return self.merge_conv(self.merge_conv_pad((1-arfa4_1+0.05)*content4_1+(arfa4_1+0.05)*Fcs4_1+arfa4_1**2/10*Fcss4_1
                        +self.upsample5_1((1-arfa5_1+0.05)*content5_1+(arfa5_1+0.05)*Fcs5_1+arfa5_1**2/10*Fcss5_1)))
...
parser.add_argument('--decoder', type=str, default = 'decoder_iter_10000(改进2).pth')
parser.add_argument('--transform', type=str, default = 'transformer_iter_10000(改进2).pth')
...
# Advanced options
def eval(content_pre,path_style,model):
...
if __name__ == '__main__':
    ...
    style_path = 'style/la_muse.jpg'
    model = load_model('torch_model.pkl')
    output = eval(content_input, style_path,model)
