...
class Transform(nn.Module):
    ...
    def forward(self, content4_1, style4_1, content5_1, style5_1,arfa4_1,arfa5_1):
        ...
        return self.merge_conv(self.merge_conv_pad(
            (1-arfa4_1)*content4_1+arfa4_1*Fcs4_1+self.upsample5_1((1-arfa5_1)*content5_1+arfa5_1*Fcs5_1)))
...
class Net(nn.Module):
    ...
    def forward(self, content, style):
        ...
        stylized = self.transform(content_feats[3], style_feats[3], content_feats[4], style_feats[4],avg_deep_content1,avg_deep_content2)
        ...
        """IDENTITY LOSSES"""
        Icc = self.decoder(self.transform(content_feats[3], content_feats[3], content_feats[4], content_feats[4],avg_deep_content1,avg_deep_content2))
        Iss = self.decoder(self.transform(style_feats[3], style_feats[3], style_feats[4], style_feats[4],avg_deep_style1,avg_deep_style2))
